...
export const Footer = () => {
	return (
		<footer className='w-full'>
			<section className='px-2 text-lg w-full max-w-6xl'>
				<p className='py-1'>
				...
				<p className='py-1'>
					...
					. This role has allowed me to build on the skills and
					knowledge I gained from my previous experience, deepening my
					understanding of various technologies and practices.
				</p>
				<p className='py-1'>
					I am actively{' '}
					<span className='font-semibold text-pink-500'>
